...
extern void Widget_scroll( Handle self, int dx ,int dy ,Rect * confine ,Rect * clip ,Bool withChildren );
...
extern void Widget_set_capture( Handle self, Bool capture ,Handle confineTo );
