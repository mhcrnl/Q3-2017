...
package ctkDlgOptionsList;
use vars qw($VERSION);
$VERSION = '1.01';
require Tk::DialogBox;
require Tk::Derived;
@ctkDlgOptionsList::ISA = qw(Tk::Derived Tk::DialogBox);
Construct Tk::Widget 'ctkDlgOptionsList';
## ctk: Globalvars
## ctk: Globalvars end
sub ClassInit {
	my $self = shift;
...
## 	$self->Delegates(); 	(optional)
	my ($dlm1,$dlm2) = $self->editOptions($options) if(defined $options);
