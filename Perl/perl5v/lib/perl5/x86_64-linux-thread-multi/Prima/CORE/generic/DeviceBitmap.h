...
/* methods definition */
	...
	Bool ( *monochrome)( Handle self, Bool set, Bool value);
...
extern Bool DeviceBitmap_monochrome( Handle self, Bool set, Bool value);
...
#undef  get_monochrome
#undef  set_monochrome
#define get_monochrome(__hs)         monochrome((__hs),0,(Bool)0)
#define set_monochrome(__hs,__val)   monochrome((__hs),1,(__val))
#undef  get_rop
#undef  set_rop
