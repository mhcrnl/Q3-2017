...
/* methods definition */
	...
	void ( *rotate)( Handle self, int degrees );
...
extern Bool Image_hScaling( Handle self, Bool set, Bool value);
...
extern Bool Image_vScaling( Handle self, Bool set, Bool value);
extern Handle Image_bitmap( Handle self);
extern SV * Image_codecs( SV * dummy );
...
extern void Image_rotate( Handle self, int degrees );
