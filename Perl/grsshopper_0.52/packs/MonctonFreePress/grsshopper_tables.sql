...
) ENGINE=MyISAM AUTO_INCREMENT=72688 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `link` (
  ...
  `link_class` varchar(250) collate utf8_unicode_ci default NULL,
  `link_feed` varchar(250) collate utf8_unicode_ci default NULL,
  `link_section` varchar(250) collate utf8_unicode_ci default NULL,
  `link_language` varchar(250) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`link_id`),
  UNIQUE KEY `link_link` (`link_link`)
) ENGINE=MyISAM AUTO_INCREMENT=21858 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
SET character_set_client = @saved_cs_client;
...
) ENGINE=MyISAM AUTO_INCREMENT=12866 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `post` (
  ...
  `post_section` varchar(250) default NULL,
  `post_language` varchar(250) default NULL,
  `post_icon` varchar(250) default NULL,
  PRIMARY KEY  (`post_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8717 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2013-02-27 20:29:09
