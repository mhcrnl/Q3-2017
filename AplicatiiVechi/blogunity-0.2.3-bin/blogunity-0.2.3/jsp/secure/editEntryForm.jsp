...
<div id="contentLayer">
	<div class="title"><b:i18n key="EDIT_ENTRY_TITLE"/></div>
	<div class="description">
		<b:i18n key="EDIT_ENTRY_DESC"/>
	</div>
	...
	<div id="formLayer">
	<form action="<%=ctx%>/editEntryExec.secureaction" method="post">
		...
		<%}%>
		<input type="text" name="alias" size="30"maxlength="50" value="<%= (e.getAliasname() != null)? e.getAliasname() : ""%>"><br/>
		...
		<input type="hidden" name="entryId" value="<%= e.getId()%>" />
